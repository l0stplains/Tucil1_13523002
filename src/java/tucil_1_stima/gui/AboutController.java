...
public class AboutController {
    ...
    public void initialize() {
        ...
        // Fonts
        Font genkiFont48 = Font.loadFont(getClass().getResource("/tucil_1_stima/gui/assets/GenkiDesu.otf").toExternalForm(), 48);
        ...
        miaw = new AudioClip(getClass().getResource("/tucil_1_stima/gui/assets/miaw.wav").toExternalForm());
